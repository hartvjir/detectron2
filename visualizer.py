...
class Visualizer:
    ...
    def draw_dataset_dict(self, dic):
        ...
        if annos:
            ...
            #           # CUSTOM EDIT: change of labels
            #           # labels should be > list of integers
            new_labels = []
            for label in labels:
                new_labels.append(temp_dict[label])

            #           # replaced "labels=labels" with "labels=new_labels"
            self.overlay_instances(
                labels=new_labels, boxes=boxes, masks=masks, keypoints=keypts, assigned_colors=colors
            )
